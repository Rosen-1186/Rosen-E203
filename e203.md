...
| 日期 | 分支/Commit | 配置摘要 | CoreMark/MHz | IPC | branch_miss_rate | ifu_flush/non_retire | ifu_bpu_wait/non_retire | lsu_wait/non_retire | ifu_req_block/non_retire | ifu_rsp_block/non_retire | ir_busy/non_retire | 结论 |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
...
| 26/3/3 | (BHT on) b3cce04 | Phase1(BHT)+同口径计数器 | 2.177890 | 0.607 | 10.22% | 5.41% | 0.89% | 1.87% | 0.00% | 89.64% | 87.72% | 分支代价下降，但 rsp/IR 背压仍主导 |
